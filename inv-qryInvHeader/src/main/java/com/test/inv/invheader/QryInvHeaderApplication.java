...
public class QryInvHeaderApplication {

	public static void main(String[] args) {
		SpringApplication.run(QryInvHeaderApplication.class, args);
	}
	...
	public Docket createQueryRestApi() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.groupName("Query API")
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.test.inv.invheader.ctl"))
